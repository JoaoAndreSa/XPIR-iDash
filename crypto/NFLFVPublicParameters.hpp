...
#ifndef DEF_NFLFVPUBPARAMS
#define DEF_NFLFVPUBPARAMS
...
class NFLFVPublicParameters : public AbstractPublicParameters
{
  public :
    NFLFVPublicParameters();
    NFLFVPublicParameters(unsigned int modulusBitsize_, unsigned int polyDegree_, int absPCBitsize_);
    ...
    void setcrypto_container(NFLFV* c) {crypto_container=c;}
