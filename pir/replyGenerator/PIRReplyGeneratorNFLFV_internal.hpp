...
#ifndef DEF_PIRREPLYGENERATORNFLFV
#define DEF_PIRREPLYGENERATORNFLFV

#include <unistd.h>
#include <omp.h>
#include "pir/replyGenerator/GenericPIRReplyGenerator.hpp"
#include "crypto/HomomorphicCrypto.hpp"
#include "crypto/NFLFV.hpp"
#include "pir/dbhandlers/DBGenerator.hpp"

class PIRReplyGeneratorNFLFV_internal : public GenericPIRReplyGenerator
{
public:
...
public:
    PIRReplyGeneratorNFLFV_internal();
    PIRReplyGeneratorNFLFV_internal(PIRParameters& param, DBHandler *db);
    ~PIRReplyGeneratorNFLFV_internal();
